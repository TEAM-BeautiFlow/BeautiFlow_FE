...
import { ChevronLeft, X, Plus, Home, User, MessageSquare, Calendar, MoreHorizontal } from 'lucide-react';
...
const OwnerStoreIntroPage = () => {
  ...
  const handleImageUpload = () => {
    ...
    if (selectedImages.length < MAX_IMAGES) {
      // 임시로 플레이스홀더 이미지 추가
      setSelectedImages([...selectedImages, `placeholder_${selectedImages.length + 1}.png`]);
    }
    console.log('이미지 업로드');
  };
