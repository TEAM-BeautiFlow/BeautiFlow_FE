    ...
    >
      ...
      <button
        ...
        style={{
          ...
          backgroundColor: isVerificationInProgress
            ? "var(--color-grey-950)"
            : "var(--color-status-dark-red)",
          color: isVerificationInProgress
            ? "var(--color-light-purple)"
            : "var(--color-status-red)",
          border: isVerificationInProgress
            ? "1px solid var(--color-light-purple)"
            : "none", // Figma에 따라 border: none 유지
      ...
      >
        <button
          className="label1 border-b-2 px-2 py-3"
          style={{
      ...
      <div className="flex-1 overflow-y-auto px-5 py-4 pb-20">
        ...
        <div className="mb-8">
          <div className="mb-4 flex items-center justify-between">
            <h3 className="label1" style={{ color: "var(--color-white)" }}>
              매장 정보
            </h3>
            <button
              className="caption2"
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-2">
              ...
              />{" "}
              {/* 전화 아이콘 대신 MessageSquare 사용 */}
              <span className="body2" style={{ color: "var(--color-white)" }}>
                {isVerificationInProgress ? "02-456-7890" : "-"}
              </span>
            </div>
            <div className="flex items-start gap-2">
              ...
              <span
                className="body2"
                style={{ color: "var(--color-white)", lineHeight: "1.5" }}
              >
                {isVerificationInProgress
                  ? "서울 종로구 삼일대로 428 낙원상가 2층 87호 2층 87호 2층 87호"
                  : "-"}
              </span>
            </div>
          </div>
        ...
        <div className="mb-8">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <span className="body2" style={{ color: "var(--color-white)" }}>
                {isVerificationInProgress ? "한 줄 소개입니다." : "-"}
              </span>
            </div>
            <div className="flex items-center gap-2">
              <Image size={16} style={{ color: "var(--color-grey-450)" }} />
              <span className="body2" style={{ color: "var(--color-white)" }}>
                {isVerificationInProgress ? "imageName.png" : "-"}
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              {/* 계좌 아이콘 대신 Home 사용 */}
              <span className="body2" style={{ color: "var(--color-white)" }}>
                {isVerificationInProgress ? "국민 110-987-231553 손하늘" : "-"}
              </span>
            </div>
            <div className="flex items-center gap-2">
              <DollarSign
              ...
              />
              <span className="body2" style={{ color: "var(--color-white)" }}>
                {isVerificationInProgress ? "예약금 30,000원" : "-"}
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              <Clock size={16} style={{ color: "var(--color-grey-450)" }} />
              <span className="body2" style={{ color: "var(--color-white)" }}>
                {isVerificationInProgress ? "평일 9:00 ~ 19:00 (월~일)" : "-"}
              </span>
            </div>
            <div className="flex items-center gap-2">
              <Calendar size={16} style={{ color: "var(--color-grey-450)" }} />{" "}
              {/* 공휴일 아이콘 대신 Calendar 사용 */}
              <span className="body2" style={{ color: "var(--color-white)" }}>
                {isVerificationInProgress ? "공휴일 정상영업" : "-"}
              </span>
            </div>
          </div>
        </div>
