...
const OwnerAnnouncementsPage = () => {
  ...
  return (
    ...
    >
      ...
      {/* Profile Section */}
      <div
        className="flex space-x-3 px-5 py-4"
        style={{ backgroundColor: "var(--color-black)" }}
      >
        <div
        ...
        <div className="flex flex-1 flex-col">
          <div className="flex items-center">
            <h2
              className="title1"
              style={{ color: "var(--color-white)", marginRight: "8px" }}
            >
              뷰티플로우
            </h2>
        ...
        {[1, 2].map(
          (
            ...
            >
              ...
              >
                공지 사항을 읽고 예약해주세요. 최대 2줄까지 보입니다. 나머지는
                더보기를 통해 확인할 수 있습니다. 디자인은...
              </p>
            </div>
          ),
        )}
