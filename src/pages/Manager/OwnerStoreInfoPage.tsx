    ...
    <div className="max-w-sm mx-auto min-h-screen" style={{ 
      ...
      <main style={{ padding: '0 20px 32px' }}>
        ...
        <div style={{ marginBottom: '24px' }}>
          <label htmlFor="shopName" className="label1" style={{ color: 'var(--color-white)', marginBottom: '8px', display: 'block' }}>
        ...
        {/* 매장 연락처 입력 필드 */}
        <div style={{ marginBottom: '24px' }}>
          <label htmlFor="contact" className="label1" style={{ color: 'var(--color-white)', marginBottom: '8px', display: 'block' }}>
            매장 연락처
          </label>
          <input
            id="contact"
        ...
        {/* 매장 위치 입력 필드 */}
        <div>
          <label htmlFor="address" className="label1" style={{ color: 'var(--color-white)', marginBottom: '8px', display: 'block' }}>
            매장 위치
          </label>
           <div style={{ position: 'relative' }}>
            <input
