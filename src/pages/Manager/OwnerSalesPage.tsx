    ...
    <div className="max-w-sm mx-auto min-h-screen" style={{ 
      ...
      <div style={{ padding: '0 20px 32px' }}> {/* Figma에 맞춰 패딩 조정 */}
        ...
        <div style={{ marginBottom: '24px' }}>
          <label htmlFor="reservationAmount" className="label1" style={{ color: 'var(--color-white)', marginBottom: '8px', display: 'block' }}>
        ...
        <div style={{ marginBottom: '32px' }}> {/* Figma에 맞춰 마진 조정 */}
          <label htmlFor="depositorName" className="label1" style={{ color: 'var(--color-white)', marginBottom: '8px', display: 'block' }}>
