...
const TreatmentOptionsPage = () => {
  ...
  const handleOptionSelect = (
    category: keyof typeof OptionsData.optionCategories,
    optionId: string,
  ) => {
  ...
  const renderOptionGroup = (
    ...
    <div className="mb-6">
      ...
      <div className="space-y-2">
        {OptionsData.optionCategories[category].map(
          (
            option: OptionsData.Option, // OptionsData.Option으로 접근
          ) => (
            <div
              key={option.id}
    ...
    >
      ...
      <div className="px-5 py-4">
        ...
        <div className="mb-20">
          ...
          {renderOptionGroup("management", "랩핑")}{" "}
          {/* Figma에 '랩핑'으로 표시 */}
        </div>
      </div>
