    ...
    <div className="max-w-sm mx-auto min-h-screen" style={{ 
      ...
      <div style={{ padding: '0 20px 32px' }}> {/* Figma에 맞춰 패딩 조정 */}
        ...
        <div style={{ marginBottom: '32px' }}> {/* Figma에 맞춰 마진 조정 */}
          <h2 className="label1" style={{ color: 'var(--color-white)', marginBottom: '16px' }}>예약 정보</h2>
          <div style={{ 
            ...
            {[
              ...
              <div 
                ...
                style={{ 
                  display: 'flex', 
                  borderBottom: index === 5 ? 'none' : '1px solid var(--color-grey-850)' // 마지막 줄은 border 없음
                }}
              >
        ...
        {/* 취소 및 환불 안내 섹션 */}
        <div style={{ marginBottom: '32px' }}> {/* Figma에 맞춰 마진 조정 */}
          <h2 className="label1" style={{ color: 'var(--color-white)', marginBottom: '16px' }}>취소 및 환불 안내</h2>
          <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
            <li className="body2" style={{ color: 'var(--color-grey-450)', lineHeight: '1.5', position: 'relative', paddingLeft: '16px' }}>
              <span style={{ position: 'absolute', left: '0' }}>•</span> 예약을 신청하면 관리자가 보증금(예약금) 입금 여부와 해당 시간대의 가능 여부를 확인하고, 예약 상태를 변경해요
            </li>
        ...
        {/* 약관 동의 섹션 */}
        <div style={{ marginBottom: '100px' }}> {/* 하단 버튼 공간 확보를 위해 마진 조정 */}
          <h2 className="label1" style={{ color: 'var(--color-white)', marginBottom: '16px' }}>약관 동의</h2>
          ...
          >
            <div style={{
              ...
              backgroundColor: agreements.all ? 'var(--color-purple)' : 'transparent',
              display: 'flex',
              alignItems: 'center',
            ...
            <span className="body1" style={{ color: 'var(--color-white)' }}>모두 동의합니다</span>
          </div>

          {/* 개별 약관들 */}
          <div style={{ paddingLeft: '32px', display: 'flex', flexDirection: 'column', gap: '12px' }}> {/* Figma에 맞춰 패딩 및 간격 조정 */}
            {/* 개인정보 제3자 제공 동의 */}
            <div 
            ...
            >
              <div style={{
                ...
                backgroundColor: agreements.privacy ? 'var(--color-purple)' : 'transparent',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
                transition: 'background-color 0.2s, border-color 0.2s'
              }}>
                {agreements.privacy && <Check size={16} color="var(--color-white)" />}
              </div>
              <div style={{ flex: 1, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <span className="body2" style={{ color: 'var(--color-white)' }}>[필수] 개인정보 제3자 제공 동의</span>
                <span className="caption2" style={{ color: 'var(--color-grey-450)' }}>보기</span>
              </div>
            </div>
            ...
            >
              <div style={{
                ...
                backgroundColor: agreements.terms ? 'var(--color-purple)' : 'transparent',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
                transition: 'background-color 0.2s, border-color 0.2s'
              }}>
                {agreements.terms && <Check size={16} color="var(--color-white)" />}
              </div>
              <div style={{ flex: 1, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <span className="body2" style={{ color: 'var(--color-white)' }}>[필수] 이용약관 동의</span>
                <span className="caption2" style={{ color: 'var(--color-grey-450)' }}>보기</span>
              </div>
            </div>
          </div>
