    ...
    >
      ...
      <div style={{ padding: "0 20px 32px" }}>
              ...
              <div
                ...
                style={{
                  ...
                  borderBottom:
                    item.label === "예약금액"
                      ? "none"
                      : "1px solid var(--color-grey-750)", // border 색상도 조정
                }}
              >
                <div
                  className="body2"
                ...
                >
                  {item.label}
                  {item.value &&
                    item.value !== item.price && ( // '없음', '1~5개' 등 추가 정보
                      <span
                        className="ml-1"
                        style={{ color: "var(--color-grey-450)" }}
                      >
                ...
                <div className="body2" style={{ color: "var(--color-white)" }}>
        ...
        <div style={{ marginBottom: "16px" }}>
          ...
          >
            <span className="label1" style={{ color: "var(--color-white)" }}>
              매장에서 결제할 금액
            </span>
            <span className="label1" style={{ color: "var(--color-white)" }}>
              60,000원
